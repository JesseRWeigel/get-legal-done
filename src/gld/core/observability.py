...
Adapted from GPD's observability.py for legal research.
"""
...
class SessionLogger:
    ...
    def log_citation_verified(self, citation: str, exists: bool) -> None:
        self.log("citation_verified", {"citation": citation, "exists": exists})
