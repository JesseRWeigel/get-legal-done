"""MCP server for GLD protocol / phase lifecycle management.

Exposes tools for parsing ROADMAP.md, computing dependency waves,
discovering plans, and managing the legal research phase lifecycle.
"""
...
from gld.core.constants import ProjectLayout, get_layout
from gld.core.phases import (
    parse_roadmap,
    compute_waves,
    discover_plans,
    discover_summaries,
