"""MCP server for GLD convention lock management.

Exposes tools for locking, querying, and diffing legal research
conventions (jurisdiction, governing law, citation format, etc.).
"""
...
from gld.core.constants import ProjectLayout, CONVENTION_FIELDS
from gld.core.conventions import (
    list_all_fields,
    check_conventions,
    diff_conventions,
...
async def list_tools() -> list[Tool]:
    return [
        Tool(
            ...
            description="List all legal convention fields with descriptions and examples.",
