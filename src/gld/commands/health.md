...
Run diagnostic checks on the GLD project and optionally fix issues.

### Checks

1. **Required files**: .gld/ directory exists, STATE.md, state.json, ROADMAP.md, config.json
...
- Initialize missing .gld/ subdirectories
