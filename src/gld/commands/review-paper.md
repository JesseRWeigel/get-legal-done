...
1. **Existence check**: Does the cited work exist? Verify against:
   - CourtListener, Westlaw references, HeinOnline, Google Scholar, and Bluebook format verification
...
Load convention locks from .gld/conventions.json.
...
Spawn gld-referee with the manuscript. The referee runs 5 independent review perspectives:
...
#### 4f. Jurisdictional Review
- Are all cited authorities from the correct jurisdiction?
- Is the hierarchy of authority respected (binding vs persuasive)?
- Are statutory citations current (not amended or repealed)?
- Is the legal reasoning logically sound and well-supported?
