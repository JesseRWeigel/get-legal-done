...
### Step 1: Load State
Read STATE.md and state.json via gld-state.
...
If `.gld/.continue-here.md` exists:
- Read it for exact position, authorities found, and planned next steps
- This is the highest-priority resume path

### Step 4: Check for Partial Completion
If no continue-here file:
- Scan git log for recent [gld] commits
