 ...
 *
 * Usage:
 *   npx get-legal-done                  # Interactive
 *   npx get-legal-done --local          # Install into current project
 *   npx get-legal-done --global         # Install globally
 *   npx get-legal-done --uninstall      # Remove
 */
...
const BRAND = {
  name: "get-legal-done",
  displayName: "Get Legal Done",
  prefix: "gld",
  pyModule: "gld",
  homeDir: ".gld",
  homeDirEnv: "GLD_HOME",
  description: "AI copilot for autonomous legal research and brief writing",
  repo: "https://github.com/JesseRWeigel/get-legal-done",
};
